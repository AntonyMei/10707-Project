...
from onpolicy.runner.qiskit_sabre.customized_sabre_transpiler import sabre_pass_manager
from math import pi
...
def sabre_round(seed, qasm_file_name, device_name):
    ...
    return sabre_swap_count, logical2physical


def run_sabre(qasm_file_name, device_name, num_runs, num_saves, save_path_list, seed):
    ...
    sabre_swap_count_list, logical2physical_list = zip(
    ...
    for swap_count, mapping in sorted(zip(sabre_swap_count_list, logical2physical_list),
