...
from onpolicy.algorithms.quartz_ppo.model.representation_network import RepresentationNetworkSimple
from onpolicy.algorithms.quartz_ppo.model.actor_critic import ValueNetwork, PolicyNetworkSimple
...
class PPONetwork(nn.Module):
    ...
    def policy_value_forward(self, circuit_batch, physical2logical_mapping_batch, action_space_batch):
        """
        input:  circuit_batch, physical2logical_mapping_batch: list of observations
                action_space_batch: list of decoded action space (see utils.DecodePyActionList)
        output: selected_action_list: a list of tuples (qubit idx 0, qubit idx 1)
        ...
        """
        # get action probability
        register_rep, attention_score = self.representation_network(circuit_batch=circuit_batch,
                                                                    physical2logical_mapping_batch=physical2logical_mapping_batch)
        action_prob_batch = self.policy_network(attention_score, action_space_batch)
    ...
    def evaluate_action_value_forward(self, circuit_batch, physical2logical_mapping_batch, action_space_batch,
                                      action_id_batch):
        """
        input:  circuit_batch, physical2logical_mapping_batch: list of observations
                action_space_batch: list of decoded action space (see utils.DecodePyActionList)
