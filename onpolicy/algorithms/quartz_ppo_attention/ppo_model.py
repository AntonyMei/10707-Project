import torch
from onpolicy.algorithms.quartz_ppo.model.ppo_network import PPONetwork
from onpolicy.algorithms.quartz_ppo.utils.utils import update_linear_schedule
...
class PPOModel:
    ...
    def act(self, circuit_batch, physical2logical_mapping_batch, action_space_batch, deterministic=False):
        """
