...
def start_evaluation(rank, all_args):
    ...
    while True:
        ...
        filename_list = os.listdir(f"./experiment/{all_args.qasm_file_name}/{all_args.backend_name}/eval_model_dir")
        ...
        raw_state_dict = torch.load(f"./experiment/{all_args.qasm_file_name}/{all_args.backend_name}/eval_model_dir"
                                    f"/{latest_model_name}")
