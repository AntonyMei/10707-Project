...
echo "env is ${env}, algo is ${algo}, exp is ${exp}, seed is ${seed}"
    ...
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0,1,2,3 python two_way_rollout.py \
     ...
     \
     --use_eval --n_eval_rollout_threads 32 --eval_episodes 1500 --eval_interval 200 \
     \
     --qasm_file_name "" --backend_name "" \
     ...
     \
     --two_way_mode "none" --two_way_save_interval -1 --two_way_save_count -1 --two_way_clear_on_save False \
     --reversed_qasm_file_name "none"