...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0,1,2,3 python test_random_search_api.py \
     ...
     --world_size 4 \
     \
     --search_type "random" --search_interval 100 --search_rounds 20 --round_budget 100 \
     --save_count 20 --random_search_lambda 20
done