...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0,1,2,3 python random_correlation.py \
     ...
     --world_size 4 \
     \
     --search_type "random" --search_interval 100 --search_rounds 20 --round_budget 200 \
     --save_count 10 --random_search_lambda 30 --cuda_idx $1
done